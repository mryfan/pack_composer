...
return [
    ...
    'dist_dir' => __DIR__ . DIRECTORY_SEPARATOR . '../../dist',//定义最终生成的目录
    'tmp_dir' => __DIR__ . DIRECTORY_SEPARATOR . '../../tmp',  //定义执行完命令后生成的临时目录
    'exclude_files_path'=>[
    ],//暂时不需要
    'tpl_path'=>dirname(__DIR__).DIRECTORY_SEPARATOR.'tpl',//模板的目录
